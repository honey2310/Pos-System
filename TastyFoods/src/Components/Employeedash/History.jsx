...
export default function History() {
  const history = [
    { id: "ORD-0990", item: "Garlic Toast", total: "$2.50", date: "2025-10-05" },
    { id: "ORD-0991", item: "Crispy Chicken", total: "$5.10", date: "2025-10-06" },
    { id: "ORD-0992", item: "Submarine Sandwich", total: "$6.99", date: "2025-10-07" },
    { id: "ORD-0993", item: "Bacon Burger", total: "$8.68", date: "2025-10-08" },
  ];
      ...
      <div className="bg-gray-900/60 border border-gray-800 rounded-3xl overflow-hidden shadow-lg shadow-black/40 backdrop-blur-md hover:shadow-[0_0_30px_rgba(255,0,0,0.15)] transition-all duration-300">
        <table className="w-full text-left">
          <thead className="bg-gray-800/60 text-gray-300">
            <tr>
              {["Order ID", "Item", "Total", "Date", "Status"].map((header, i) => (
                <th
                  key={i}
